    ...
    <>
      {props.error ? (
        ...
        ${props.darkMode ? "text-slate-950" : "text-white"} ${
          ...
          <div className="flex gap-x-[2rem] lg:gap-x-[3rem] md:gap-x-[3rem]">
            ...
            <div className=" flex flex-col w-full">
              <div className="flex flex-col md:flex-row lg:flex-row justify-between">
                ...
                <h2
                  className={`${
                    props.darkMode ? "text-slate-950" : "text-slate-400"
                  } text-lg`}>
                  {props.createdate.slice(0, 10)}
                </h2>
              </div>
              <div className="mt-1">
                <h4 className="text-blue-400 cursor-pointer text-md">
                  <Link to={props.idUrl} target="_blank">
                    {"@" + props.userName}
                  </Link>
                </h4>
              </div>
          ...
          <div
            className={`flex flex-row p-[1rem] ${
              props.darkMode ? "bg-purple-500" : "bg-slate-950"
            } mt-[2rem] lg:mt-[3rem] rounded-lg justify-between md:justify-evenly lg:justify-evenly`}>
          ...
          <div className="text-wrap grid grid-cols-1 md:grid-cols-2 place-item-start md:place-items-center lg:place-items-center md:grid-rows-2 lg:grid-cols-2 lg:grid-rows-2 mt-[2rem] gap-y-2 md:gap-y-[2rem] lg:mt-[4rem] lg:gap-y-[2rem] ">
            ...
            <div className="flex gap-x-2 lg:w-auto md:w-auto ">
